...
ALL_QUESTIONS = [
    ...
    {"q": "Πώς λέγεται όταν βάζεις την μπάλα καρφωτά μέσα στο καλάθι;", "opts": ["Πάσα", "Κάρφωμα", "Ντρίμπλα", "Φάουλ"], "ans": "B", "diff": "Εύκολο"},
    {"q": "Πώς λέγεται όταν χτυπάς την μπάλα στο πάτωμα ενώ κινείσαι;", "opts": ["Ντρίμπλα", "Πάσα", "Σουτ", "Τάπα"], "ans": "A", "diff": "Εύκολο"},
    {"q": "Από ποια χώρα κατάγεται ο ΛεΜπρόν Τζέιμς;", "opts": ["Καναδάς", "ΗΠΑ", "Γαλλία", "Νιγηρία"], "ans": "B", "diff": "Εύκολο"},
    {"q": "Σε ποια ομάδα του NBA κέρδισε πρωτάθλημα ο Γιάννης Αντετοκούνμπο το 2021;", "opts": ["Λος Άντζελες Λέικερς", "Μιλγουόκι Μπακς", "Μαϊάμι Χιτ", "Σικάγο Μπουλς"], "ans": "B", "diff": "Εύκολο"},
    {"q": "Τι μετάλλιο κατέκτησε η Εθνική Ελλάδος στο EuroBasket 2025;", "opts": ["Χρυσό", "Ασημένιο", "Χάλκινο", "Κανένα"], "ans": "C", "diff": "Εύκολο"},
    ...
    {"q": "Πώς λέγεται το πιάσιμο της μπάλας μετά από μια αστοχία;", "opts": ["Ασίστ", "Ριμπάουντ", "Κλέψιμο", "Βήμα"], "ans": "B", "diff": "Μέτριο"},
    {"q": "Πώς λέγεται η πάσα που καταλήγει απευθείας σε καλάθι;", "opts": ["Ασίστ", "Τάπα", "Φάουλ", "Σέντρα"], "ans": "A", "diff": "Μέτριο"},
    {"q": "Πόσα πρωταθλήματα NBA κατέκτησε ο Μάικλ Τζόρνταν;", "opts": ["3", "5", "6", "8"], "ans": "C", "diff": "Μέτριο"},
    {"q": "Σε ποια ομάδα έπαιξε ΟΛΗ του την καριέρα ο Κόμπι Μπράιαντ;", "opts": ["Λος Άντζελες Λέικερς", "Βοστώνη Σέλτικς", "Σικάγο Μπουλς", "Μαϊάμι Χιτ"], "ans": "A", "diff": "Μέτριο"},
    {"q": "Ποια εθνική ομάδα κέρδισε το EuroBasket 2025;", "opts": ["Γερμανία", "Τουρκία", "Ελλάδα", "Ισπανία"], "ans": "A", "diff": "Μέτριο"},
    {"q": "Ποια ομάδα κατέκτησε το πρωτάθλημα του NBA το 2025;", "opts": ["Βοστώνη Σέλτικς", "Οκλαχόμα Σίτι Θάντερ", "Ντένβερ Νάγκετς", "Λος Άντζελες Λέικερς"], "ans": "B", "diff": "Μέτριο"},
    {"q": "Κάθε πόσα χρόνια διοργανώνεται το Παγκόσμιο Κύπελλο Μπάσκετ (FIBA World Cup);", "opts": ["2", "3", "4", "5"], "ans": "C", "diff": "Μέτριο"},
    {"q": "Πώς λέγεται ο παίκτης που οργανώνει το παιχνίδι της ομάδας;", "opts": ["Σέντερ", "Πλεϊμέικερ", "Πάουερ φόργουορντ", "Σούτινγκ γκαρντ"], "ans": "B", "diff": "Μέτριο"},
    {"q": "Ο Θανάσης Αντετοκούνμπο έπαιξε στους Μπακς μαζί με ποιον;", "opts": ["Τον αδερφό του Γιάννη", "Τον Κόμπι Μπράιαντ", "Τον Στεφ Κάρι", "Τον Λούκα Ντόντσιτς"], "ans": "A", "diff": "Μέτριο"},
    ...
    {"q": "Ποια εθνική ομάδα κατέκτησε το Παγκόσμιο Κύπελλο (FIBA World Cup) το 2023;", "opts": ["ΗΠΑ", "Γερμανία", "Ισπανία", "Σερβία"], "ans": "B", "diff": "Δύσκολο"},
